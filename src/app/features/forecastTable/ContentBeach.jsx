    ...
    <StyledTable className="tab-content bg-light">
        {
            props.days.map((day, i) =>
                <div key={i} className={'tab-pane' + (i === props.activeContent ? ' show active' : ' fade')}
                    ...
                    <table className="tableFixed tabla-7">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th><i className="wi wi-tsunami i-cabecera-tabla" /></th>
                                <th><i className="wi wi-wind wi-from-ssw i-cabecera-tabla" /></th>
                            </tr>
                        </thead>
                        <tbody>
                            {
                                day.skyState.map((sk, i) =>
                                    <tr key={i}>
                                        ...
                                        <td>{day.significativeWaveHeight[i].value}</td>
                                        <td><img alt="Icono de dirección das ondas" src={getHttpsUrl(day.meanWaveDirection[i].iconURL)} /></td>
                                    </tr>
                                )
                            }
                        </tbody>
